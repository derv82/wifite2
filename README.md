...
## Install Python
    ...
    sudo apt aupdate -y && sudo apt install aptitude -y && aptitude install python-pip python3-pip -y && pip install pysqlcipher3 && pip install psycopg2-binary
